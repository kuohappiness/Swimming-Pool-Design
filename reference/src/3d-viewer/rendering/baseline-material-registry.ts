...
function createEntries(): MaterialEntries {
  ...
  return [
    ...
    ['sanitary-metal', new THREE.MeshStandardMaterial({ color: 0xc8d0d1, roughness: 0.26, metalness: 0.78 })],
    ['sanitary-seat', new THREE.MeshStandardMaterial({ color: 0xe5e7e3, roughness: 0.38 })],
    ['sanitary-dark', new THREE.MeshStandardMaterial({ color: 0x30393b, roughness: 0.58, metalness: 0.18 })],
    ['wet-surface', new THREE.MeshStandardMaterial({ color: 0xa8c4c6, roughness: 0.2, transparent: true, opacity: 0.22, depthWrite: false })],
    ['interior-tile', new THREE.MeshStandardMaterial({ color: 0xd6dfdc, roughness: 0.76 })],
    ['interior-grout', new THREE.MeshStandardMaterial({ color: 0x8c9694, roughness: 0.96 })],
    ['interior-light', new THREE.MeshStandardMaterial({ color: 0xfff7e4, roughness: 0.42, emissive: 0xffe9bd, emissiveIntensity: 0.5 })],
    ['signage', new THREE.MeshStandardMaterial({ color: 0x3f6469, roughness: 0.62 })],
    ...
    ['pool-caustic', new THREE.MeshBasicMaterial({ color: 0xc9fbff, transparent: true, opacity: 0.08, depthWrite: false, blending: THREE.AdditiveBlending })],
