...
| TASK-004 | 套件、模型與現行文件同步至 0.2.0 | in_progress | 0.2.0 | [版本流程](06_WORKFLOW_AND_RELEASES.md) | TASK-001、TASK-002、TASK-003、TASK-006 | `package.json`、lockfile、modelVersion、revision 與現行文件一致為 0.2.0 |
...
`TASK-001` 已完成；`TASK-004` 正在同步 0.2.0 版號，完成後執行 `TASK-005` 發布門檻。
