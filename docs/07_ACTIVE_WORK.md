...
| --- | --- | --- | --- | --- | --- | --- |
| TASK-001 | 太陽研究 180° 方位修正 | in_progress | 0.2.0 | [DEC-029](04_DECISIONS_AND_OPEN_ITEMS.md)、[修正計畫](specs/2026-07-14-solar-orientation-correction-implementation-plan.md)、[solar contract](contracts/solar-study.md) | TASK-003 | 固定建築與 2F 使用本地 +X 307° transform；127° 只作面池法線／反射目標；方位一致性測試通過 |
...
`TASK-001` 正在執行；完成後依 `TASK-004`、`TASK-005` 順序處理。
